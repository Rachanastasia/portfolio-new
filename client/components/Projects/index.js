...
const PROJECTS = [
    ...
    },
    {
        ...
        description: "This fullstack project explores the connections between data in GraphQL resolvers with the JavaScript implementation of GraphQL.",
        stack: ['React', 'GraphQL', 'Apollo', 'Node.js', 'Express', 'CSS3'],
        image: GraphQLBookshelf,
        links: [
